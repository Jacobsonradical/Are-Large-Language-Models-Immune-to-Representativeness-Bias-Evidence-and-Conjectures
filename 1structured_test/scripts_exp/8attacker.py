...
if __name__ == "__main__":
    exp_amb_dir = "../1raw/8attacker"
    os.makedirs(exp_amb_dir, exist_ok=True)

    exp_choice = ["The population of people shorter than 185 cm and those 185 cm and taller is roughly equal in size. "
                  "However, 85% of such attackers are people under 185 cm, while only 15% attackers "
                  "are 185 cm or taller.",
                  "A witness identified the attacker as being 185 cm or taller. The court assessed the witness's "
                  "ability to judge a person's height under conditions similar to that night. Given a sample of "
                  "people, half shorter than 185 cm and half 185 cm or taller, the witness correctly identified "
                  "height 80% of the time and erred in 20% of the cases."]
    ...
    model_round = {"gpt-4o": [(i, i + 9) for i in range(1, 331, 9 + 1)],
                   "gpt-4-turbo": [(i, i + 9) for i in range(1, 371, 9 + 1)],
                   "gpt-3.5-turbo-0125": [(i, i + 9) for i in range(1, 371, 9 + 1)],
                   ...
                   "claude-3-opus-20240229": [(i, i + 9) for i in range(1, 431, 9 + 1)],
                   "claude-3-sonnet-20240229": [(i, i + 9) for i in range(1, 151, 9 + 1)],
                   "claude-3-haiku-20240307": [(i, i + 9) for i in range(1, 271, 9 + 1)],
                   # "open-mistral-7b": [(i, i + 9) for i in range(1, 851, 9 + 1)],
                   "mistral-large-latest": [(i, i + 9) for i in range(1, 481, 9 + 1)],
                   "mistral-medium-latest": [(i, i + 9) for i in range(1, 571, 9 + 1)],
                   "mistral-small-latest": [(i, i + 9) for i in range(1, 201, 9 + 1)]}
    ...
    model_round_2 = {"open-mixtral-8x22b": [(i, i + 9) for i in range(1, 151, 9 + 1)],
                     "open-mixtral-8x7b": [(i, i + 9) for i in range(1, 601, 9 + 1)]}
