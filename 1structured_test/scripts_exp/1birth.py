...
if __name__ == "__main__":
    exp_amb_dir = "../1raw/1birth"
    os.makedirs(exp_amb_dir, exist_ok=True)

    # open-mixtral-8x22b, mistral-small-latest are excluded due to poor performance.
    list_models = ["gpt-4o", "gpt-4-turbo", "gpt-3.5-turbo-0125",
                   ...
                   "open-mixtral-8x7b", "open-mistral-7b", "mistral-large-latest",
                   "mistral-medium-latest"]

    with open("1birth.txt", "rt") as f:
        exp_prompt = f.read()

    with concurrent.futures.ProcessPoolExecutor(max_workers=25) as executor:
        futures = [executor.submit(exp, exp_amb_dir, exp_prompt, exp_model_name, 1, 100, 900)
