...
if __name__ == "__main__":
    ...
    model_round = {"gpt-4o": [(i, i + 9) for i in range(1, 151, 9 + 1)],
                   ...
                   "gpt-3.5-turbo-0125": [(i, i + 9) for i in range(1, 521, 9 + 1)],
                   "gemini-1.5-pro-latest": [(i, i + 9) for i in range(1, 291, 9 + 1)],
                   "gemini-1.5-flash-latest": [(i, i + 9) for i in range(1, 151, 9 + 1)],
                   "gemini-1.0-pro-latest": [(i, i + 9) for i in range(1, 501, 9 + 1)],
